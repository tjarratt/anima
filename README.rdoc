...
Check out the current version on heroku: http://anima-visualizations.herokuapp.com (requires Chrome)
...
We're very open to trying new things, so drop us a line, or feel free to fork
...
You should be able to get started by forking this repository and running these commands
 ...
 git clone https://github.com/tjarratt/anima.git
 cd anima
 bundle install
 rails s
